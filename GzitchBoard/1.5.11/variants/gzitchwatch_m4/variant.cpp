...
const PinDescription g_APinDescription[]=
{
  ...
  // 13 (LED)
  // JdE swap out D13 (PA22) for PB3, STATUS LED
  ...
  //JdE swap D+ and D-
  { PORTA, 25, PIO_COM, PIN_ATTR_NONE, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_9 },// USB/DM
  { PORTA, 24, PIO_COM, PIN_ATTR_NONE, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_8 },  // USB/DP
